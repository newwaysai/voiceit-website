    ...
    <div className="bg-background min-h-screen text-primary">
      <main className="pt-16 pb-20 px-6 md:px-16 max-w-4xl mx-auto">
        ...
        <div className="font-sans text-primary/70 space-y-8 leading-relaxed text-sm">
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">10. Data protection and data processing agreement (B2B)</h2>
            <p>
              How Voiceit processes personal data is described in the{' '}
              <a href="/en/privacy" className="text-accent underline">Privacy Policy</a>.
            </p>
            <p className="mt-3">
              <strong className="text-primary">Business customers (B2B):</strong> If you use Voiceit
              in a business context and process personal data of employees or third parties, you are
              required under Art. 28 GDPR to enter into a Data Processing Agreement (DPA) with us.
              We will provide a DPA on request. Contact:{' '}
              <a href="mailto:hello@voiceitai.app" className="text-accent underline">hello@voiceitai.app</a>
            </p>
            <p className="mt-3">
              The pure dictation function (local transcription without AI features) involves no data
              transfer to our servers and does not require a DPA.
            </p>
          </section>

          <section>
            <h2 className="text-xl font-bold text-primary mb-4">11. AI output disclaimer</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">14. Service availability</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">15. Liability</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">16. Warranty and update obligation</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">17. Changes to these Terms</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">18. Governing law and venue</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">19. EU Online Dispute Resolution</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-primary mb-4">20. Severability</h2>
            <p>
