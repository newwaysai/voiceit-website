    ...
    modes: [
      {
        ...
        body: 'Die Basis. 100% lokal. Lokales Voice-Modell läuft direkt auf deinem Mac. Audio verlässt dein Gerät nie. Kostenlos testen.',
    ...
    modes: [
      {
        ...
        body: 'The basics. 100% local. Local voice model runs right on your Mac. Audio never leaves the device. Test for free.',
