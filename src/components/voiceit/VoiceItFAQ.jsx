...
const COPY = {
  de: {
    ...
    faqs: [
      ...
      { q: 'Was kostet Voiceit konkret?', a: 'Diktat unbegrenzt: 0 €, immer. Pro mit 500 KI-Aufrufen: 15 € / Monat (zzgl. MwSt für EU-Kunden). Premium mit 3.000 KI-Aufrufen: 30 € / Monat (zzgl. MwSt). Stripe-Checkout, jederzeit kündbar, kein Vertrag.' },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'How much does Voiceit cost exactly?', a: 'Unlimited dictation: €0, always. Pro with 500 AI calls: €15 / month (plus VAT for EU customers). Premium with 3,000 AI calls: €30 / month (plus VAT). Stripe checkout, cancel any time, no contract.' },
