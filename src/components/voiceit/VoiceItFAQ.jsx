...
const COPY = {
  de: {
    ...
    faqs: [
      ...
      { q: 'Was kostet Voiceit konkret?', a: 'Diktat unbegrenzt: 0 €, immer. Pro mit 500 KI-Aufrufen: 15 € / 4 Wochen. Premium mit 3.000 KI-Aufrufen: 30 € / 4 Wochen. Abrechnung alle 4 Wochen via Stripe-Checkout, jederzeit kündbar, kein Vertrag.' },
  ...
  en: {
    ...
    faqs: [
      ...
      { q: 'How much does Voiceit cost exactly?', a: 'Unlimited dictation: €0, always. Pro with 500 AI calls: €15 / 4 weeks. Premium with 3,000 AI calls: €30 / 4 weeks. Billed every 4 weeks via Stripe checkout, cancel any time, no contract.' },
