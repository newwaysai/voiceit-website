...
const COPY = {
  de: {
    ...
    headingA: 'Häufige',
    headingB: 'Fragen.',
    sub: 'Was Leute fragen, bevor sie installieren.',
    ...
    faqs: [
      ...
      { q: 'Was kostet Voiceit konkret?', a: 'Diktat lokal & gratis (4.000 Wörter/Woche), inkl. 20 KI-Aufrufen zum Testen. Pro mit 500 KI-Aufrufen: 15 € / 4 Wochen. Premium mit 3.000 KI-Aufrufen: 30 € / 4 Wochen. Abrechnung alle 4 Wochen via Stripe-Checkout, jederzeit kündbar, kein Vertrag.' },
      { q: 'Warum unterscheidet sich Premium nur durch mehr KI-Calls?', a: 'Weil KI-Calls Geld kosten, bei jedem Anbieter. Wir nehmen darauf keine Marge. Premium ist nicht "besseres Feature", sondern "mehr Volumen für Power-User". Du zahlst Pass-Through, nicht Markup. Wer wenig KI nutzt, bleibt bei Pro. Wer jedes Meeting transkribiert und jeden Workflow promptet, nimmt Premium.' },
      { q: 'Was passiert, wenn meine 500 Pro-Calls aufgebraucht sind?', a: 'Diktat läuft weiter, lokal und ohne Limit. Nur Prompt- und Agent-Modus (die KI-Calls brauchen) pausieren bis zum nächsten Abrechnungszyklus. Keine Top-ups, keine Überraschungsrechnung. Wer regelmäßig mehr braucht, wechselt zu Premium (3.000 Calls). Bewusst klar gehalten: ein Tier, ein Preis, kein Kleingedrucktes.' },
  ...
  en: {
    ...
    headingB: 'questions.',
    sub: 'What people ask before they install.',
    ...
    faqs: [
      ...
      { q: 'How much does Voiceit cost exactly?', a: 'Dictation local & free (4,000 words/week), incl. 20 AI calls to try. Pro with 500 AI calls: €15 / 4 weeks. Premium with 3,000 AI calls: €30 / 4 weeks. Billed every 4 weeks via Stripe checkout, cancel any time, no contract.' },
      { q: 'Why does Premium only differ in more AI calls?', a: 'Because AI calls cost money, at every provider. We take no markup. Premium is not "a better feature," it is "more volume for power users." You pay pass-through, not markup. Light AI users stay on Pro. People who dictate every meeting and prompt every workflow take Premium.' },
      { q: 'What happens when my 500 Pro calls run out?', a: 'Dictation keeps running, locally and without limit. Only Prompt and Agent mode (which need AI calls) pause until the next billing cycle. No top-ups, no surprise bill. People who regularly need more switch to Premium (3,000 calls). Deliberately kept clean: one tier, one price, no fine print.' },
